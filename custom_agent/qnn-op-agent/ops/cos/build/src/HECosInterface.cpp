...
Qnn_ErrorHandle_t HECosInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HECosGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HECosValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HECosCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HECosFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HECosTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HECosLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HECosLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HECosLogTerminate() {
...
Qnn_ErrorHandle_t HECosPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HECosInit;
    interface->v1_4.terminate        = HECosTerminate;
    interface->v1_4.getInfo          = HECosGetInfo;
    interface->v1_4.validateOpConfig = HECosValidateOpConfig;
    interface->v1_4.createOpImpl     = HECosCreateOpImpl;
    interface->v1_4.freeOpImpl       = HECosFreeOpImpl;
    interface->v1_4.logInitialize    = HECosLogInitialize;
    interface->v1_4.logSetLevel      = HECosLogSetLevel;
    interface->v1_4.logTerminate     = HECosLogTerminate;
    return QNN_SUCCESS;
}
