...
DECLARE_PKG_OPS_OPTS_LIST(PKG_HEReduceMax)
END_PKG_OPS_OPTS_LIST()

static constexpr auto sg_packageName = THIS_PKG_NAME_STR;
static constexpr auto sg_opName      = "HEReduceMax";
...
Qnn_ErrorHandle_t HEReduceMaxInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HEReduceMaxGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HEReduceMaxValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HEReduceMaxCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HEReduceMaxFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HEReduceMaxTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HEReduceMaxLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HEReduceMaxLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HEReduceMaxLogTerminate() {
...
Qnn_ErrorHandle_t HEReduceMaxPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HEReduceMaxInit;
    interface->v1_4.terminate        = HEReduceMaxTerminate;
    interface->v1_4.getInfo          = HEReduceMaxGetInfo;
    interface->v1_4.validateOpConfig = HEReduceMaxValidateOpConfig;
    interface->v1_4.createOpImpl     = HEReduceMaxCreateOpImpl;
    interface->v1_4.freeOpImpl       = HEReduceMaxFreeOpImpl;
    interface->v1_4.logInitialize    = HEReduceMaxLogInitialize;
    interface->v1_4.logSetLevel      = HEReduceMaxLogSetLevel;
    interface->v1_4.logTerminate     = HEReduceMaxLogTerminate;
    return QNN_SUCCESS;
}
