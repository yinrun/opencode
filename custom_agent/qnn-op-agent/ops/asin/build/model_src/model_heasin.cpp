...
ModelError_t QnnModel_composeGraphs(
  ...
  VALIDATE(getQnnGraphConfigFromInfo("HEAsin_graph", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(model.initialize(backendHandle, interface, contextHandle, "HEAsin_graph", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
      "HEAsin_node", "HEAsinPackage", "HEAsin",
