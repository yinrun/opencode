...
ModelError_t QnnModel_composeGraphs(
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
      "HEAdd_node",  // node name
      "HEAddPackage",  // package name
      "HEAdd",       // op type
      nullptr,           // params
      0,                 // numParams
  ...
  // Do NOT call model.finalize() here — qnn-net-run's host driver calls
  ...
  // (silu/rmsnorm hit the same bug; mirror their fix.)
