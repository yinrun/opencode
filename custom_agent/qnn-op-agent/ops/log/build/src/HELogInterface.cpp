...
Qnn_ErrorHandle_t HELogInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HELogGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HELogValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HELogCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HELogFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HELogTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HELogLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HELogLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HELogLogTerminate() {
...
Qnn_ErrorHandle_t HELogPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HELogInit;
    interface->v1_4.terminate        = HELogTerminate;
    interface->v1_4.getInfo          = HELogGetInfo;
    interface->v1_4.validateOpConfig = HELogValidateOpConfig;
    interface->v1_4.createOpImpl     = HELogCreateOpImpl;
    interface->v1_4.freeOpImpl       = HELogFreeOpImpl;
    interface->v1_4.logInitialize    = HELogLogInitialize;
    interface->v1_4.logSetLevel      = HELogLogSetLevel;
    interface->v1_4.logTerminate     = HELogLogTerminate;
    return QNN_SUCCESS;
}
