...
ModelError_t QnnModel_composeGraphs(
  ...
  VALIDATE(getQnnGraphConfigFromInfo("HERound_graph", graphsConfigInfo, numGraphsConfigInfo, graphConfigs), err);
  VALIDATE(model.initialize(backendHandle, interface, contextHandle, "HERound_graph", debug, DO_GRAPH_NODE_VALIDATIONS, graphConfigs), err);
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
      "HERound_node", "HERoundPackage", "HERound",
