...
Qnn_ErrorHandle_t HEAbsInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HEAbsGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HEAbsValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HEAbsCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HEAbsFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HEAbsTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HEAbsLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HEAbsLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HEAbsLogTerminate() {
...
Qnn_ErrorHandle_t HEAbsPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HEAbsInit;
    interface->v1_4.terminate        = HEAbsTerminate;
    interface->v1_4.getInfo          = HEAbsGetInfo;
    interface->v1_4.validateOpConfig = HEAbsValidateOpConfig;
    interface->v1_4.createOpImpl     = HEAbsCreateOpImpl;
    interface->v1_4.freeOpImpl       = HEAbsFreeOpImpl;
    interface->v1_4.logInitialize    = HEAbsLogInitialize;
    interface->v1_4.logSetLevel      = HEAbsLogSetLevel;
    interface->v1_4.logTerminate     = HEAbsLogTerminate;
    return QNN_SUCCESS;
}
