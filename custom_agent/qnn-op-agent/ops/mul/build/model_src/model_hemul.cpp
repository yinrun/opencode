...
ModelError_t QnnModel_composeGraphs(
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
      "HEMul_node",  // node name
      "HEMulPackage",  // package name
      "HEMul",       // op type
      nullptr,           // params
      0,                 // numParams
  ...
  // Do NOT call model.finalize() — qnn-net-run's host driver calls
