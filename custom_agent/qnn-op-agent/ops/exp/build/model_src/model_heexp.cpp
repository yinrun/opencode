...
ModelError_t QnnModel_composeGraphs(
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
      "HEExp_node",  // node name
      "HEExpPackage",  // package name
      "HEExp",       // op type
      nullptr,           // params
      0,                 // numParams
  ...
  // (See AGENTS.md L1; same fix as silu/mul.)
