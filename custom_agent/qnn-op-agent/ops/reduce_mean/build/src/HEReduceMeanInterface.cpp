...
DECLARE_PKG_OPS_OPTS_LIST(PKG_HEReduceMean)
END_PKG_OPS_OPTS_LIST()

static constexpr auto sg_packageName = THIS_PKG_NAME_STR;
static constexpr auto sg_opName      = "HEReduceMean";
...
Qnn_ErrorHandle_t HEReduceMeanInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HEReduceMeanGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HEReduceMeanValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HEReduceMeanCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HEReduceMeanFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HEReduceMeanTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HEReduceMeanLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HEReduceMeanLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HEReduceMeanLogTerminate() {
...
Qnn_ErrorHandle_t HEReduceMeanPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HEReduceMeanInit;
    interface->v1_4.terminate        = HEReduceMeanTerminate;
    interface->v1_4.getInfo          = HEReduceMeanGetInfo;
    interface->v1_4.validateOpConfig = HEReduceMeanValidateOpConfig;
    interface->v1_4.createOpImpl     = HEReduceMeanCreateOpImpl;
    interface->v1_4.freeOpImpl       = HEReduceMeanFreeOpImpl;
    interface->v1_4.logInitialize    = HEReduceMeanLogInitialize;
    interface->v1_4.logSetLevel      = HEReduceMeanLogSetLevel;
    interface->v1_4.logTerminate     = HEReduceMeanLogTerminate;
    return QNN_SUCCESS;
}
