...
DECLARE_PKG_OPS_OPTS_LIST(PKG_HEReduceSum)
END_PKG_OPS_OPTS_LIST()

static constexpr auto sg_packageName = THIS_PKG_NAME_STR;
static constexpr auto sg_opName      = "HEReduceSum";
...
Qnn_ErrorHandle_t HEReduceSumInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HEReduceSumGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HEReduceSumValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HEReduceSumCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HEReduceSumFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HEReduceSumTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HEReduceSumLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HEReduceSumLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HEReduceSumLogTerminate() {
...
Qnn_ErrorHandle_t HEReduceSumPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HEReduceSumInit;
    interface->v1_4.terminate        = HEReduceSumTerminate;
    interface->v1_4.getInfo          = HEReduceSumGetInfo;
    interface->v1_4.validateOpConfig = HEReduceSumValidateOpConfig;
    interface->v1_4.createOpImpl     = HEReduceSumCreateOpImpl;
    interface->v1_4.freeOpImpl       = HEReduceSumFreeOpImpl;
    interface->v1_4.logInitialize    = HEReduceSumLogInitialize;
    interface->v1_4.logSetLevel      = HEReduceSumLogSetLevel;
    interface->v1_4.logTerminate     = HEReduceSumLogTerminate;
    return QNN_SUCCESS;
}
