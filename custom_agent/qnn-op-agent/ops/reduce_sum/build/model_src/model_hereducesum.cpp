...
ModelError_t QnnModel_composeGraphs(
  ...
  VALIDATE(model.addNode(QNN_OPCONFIG_VERSION_1,
      "HEReduceSum_node",  // node name
      "HEReduceSumPackage",  // package name
      "HEReduceSum",       // op type
      nullptr,           // params
      0,                 // numParams
