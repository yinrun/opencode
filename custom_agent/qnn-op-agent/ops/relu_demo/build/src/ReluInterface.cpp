//=============================================================================
// Relu FP16 Op Package Interface
// Minimal interface for single-op package registration
//=============================================================================
...
static constexpr auto sg_opName      = "HERelu";
...
Qnn_ErrorHandle_t ReluInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t ReluGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t ReluCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t ReluFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t ReluTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t ReluLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t ReluLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t ReluLogTerminate() {
...
Qnn_ErrorHandle_t InterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = ReluInit;
    interface->v1_4.terminate        = ReluTerminate;
    interface->v1_4.getInfo          = ReluGetInfo;
    interface->v1_4.validateOpConfig = ReluValidateOpConfig;
    interface->v1_4.createOpImpl     = ReluCreateOpImpl;
    interface->v1_4.freeOpImpl       = ReluFreeOpImpl;
    interface->v1_4.logInitialize    = ReluLogInitialize;
    interface->v1_4.logSetLevel      = ReluLogSetLevel;
    interface->v1_4.logTerminate     = ReluLogTerminate;
    return QNN_SUCCESS;
}
