...
Qnn_ErrorHandle_t HESinInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HESinGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HESinValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HESinCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HESinFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HESinTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HESinLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HESinLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HESinLogTerminate() {
...
Qnn_ErrorHandle_t HESinPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HESinInit;
    interface->v1_4.terminate        = HESinTerminate;
    interface->v1_4.getInfo          = HESinGetInfo;
    interface->v1_4.validateOpConfig = HESinValidateOpConfig;
    interface->v1_4.createOpImpl     = HESinCreateOpImpl;
    interface->v1_4.freeOpImpl       = HESinFreeOpImpl;
    interface->v1_4.logInitialize    = HESinLogInitialize;
    interface->v1_4.logSetLevel      = HESinLogSetLevel;
    interface->v1_4.logTerminate     = HESinLogTerminate;
    return QNN_SUCCESS;
}
