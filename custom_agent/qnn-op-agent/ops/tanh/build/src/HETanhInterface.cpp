...
Qnn_ErrorHandle_t HETanhInit(QnnOpPackage_GlobalInfrastructure_t infrastructure) {
...
Qnn_ErrorHandle_t HETanhGetInfo(const QnnOpPackage_Info_t** info) {
...
Qnn_ErrorHandle_t HETanhValidateOpConfig(Qnn_OpConfig_t opConfig) {
...
Qnn_ErrorHandle_t HETanhCreateOpImpl(QnnOpPackage_GraphInfrastructure_t graphInfra,
...
Qnn_ErrorHandle_t HETanhFreeOpImpl(QnnOpPackage_OpImpl_t opImpl) {
    (void)opImpl;
    return QNN_OP_PACKAGE_ERROR_UNSUPPORTED_FEATURE;
}

Qnn_ErrorHandle_t HETanhTerminate() {
    if (!sg_initialized) return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
...
Qnn_ErrorHandle_t HETanhLogInitialize(QnnLog_Callback_t callback, QnnLog_Level_t maxLogLevel) {
...
Qnn_ErrorHandle_t HETanhLogSetLevel(QnnLog_Level_t maxLogLevel) {
    sg_maxLogLevel = maxLogLevel;
    return QNN_SUCCESS;
}

Qnn_ErrorHandle_t HETanhLogTerminate() {
...
Qnn_ErrorHandle_t HETanhPackageInterfaceProvider(QnnOpPackage_Interface_t* interface) {
    if (!interface) return QNN_OP_PACKAGE_ERROR_INVALID_ARGUMENT;
    interface->interfaceVersion      = {1, 4, 0};
    interface->v1_4.init             = HETanhInit;
    interface->v1_4.terminate        = HETanhTerminate;
    interface->v1_4.getInfo          = HETanhGetInfo;
    interface->v1_4.validateOpConfig = HETanhValidateOpConfig;
    interface->v1_4.createOpImpl     = HETanhCreateOpImpl;
    interface->v1_4.freeOpImpl       = HETanhFreeOpImpl;
    interface->v1_4.logInitialize    = HETanhLogInitialize;
    interface->v1_4.logSetLevel      = HETanhLogSetLevel;
    interface->v1_4.logTerminate     = HETanhLogTerminate;
    return QNN_SUCCESS;
}
